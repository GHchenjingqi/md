import{_ as n,c as e,b as a,o as i}from"./app-CsUEYrmK.js";const l={};function t(c,s){return i(),e("div",null,s[0]||(s[0]=[a(`<h2 id="对象-类class" tabindex="-1"><a class="header-anchor" href="#对象-类class"><span>对象-类Class</span></a></h2><p>万物皆对象，面向对象编程。</p><h3 id="定义类" tabindex="-1"><a class="header-anchor" href="#定义类"><span>定义类</span></a></h3><p>对象主要包含 属性和方法。</p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre><code><span class="line">class 类名{</span>
