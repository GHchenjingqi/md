import{_ as e,o as n,c as s,a as t}from"./app-C8QvFSbi.js";const i={},a=t(`<h2 id="对象-类class" tabindex="-1"><a class="header-anchor" href="#对象-类class"><span>对象-类Class</span></a></h2><p>万物皆对象，面向对象编程。</p><h3 id="定义类" tabindex="-1"><a class="header-anchor" href="#定义类"><span>定义类</span></a></h3><p>对象主要包含 属性和方法。</p><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>class 类名{
	属性名: 类型;
	constructor(参数:类型){
		this.属性名 = 参数;
	}
